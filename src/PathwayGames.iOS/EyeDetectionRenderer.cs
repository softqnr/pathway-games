...
[assembly: ExportRenderer(typeof(com.fradelo.eyetracking.MainPage), typeof(com.fradelo.eyetracking.iOS.Sensors.EyeDetectionRenderer))]
namespace PathwayGames.iOS.Sensors
{
    public class EyeDetectionRenderer : PageRenderer
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            {
                //Frame = new CGRect(263, 668, 96, 128),
